...
const forwardProp = (propName) => shouldForwardProp(propName);
...
export const Box = styled(Base)({ display: "block" });
export const Flex = styled(Base)({ display: "flex" });
export const FlexWrap = styled(Base)({
    display: "flex",
    flexWrap: "wrap",
});
export const TInput = styled("input", { shouldForwardProp: forwardProp })({
    fontSize: 14,
    outline: "none",
